...
class Pulip extends StatelessWidget {
  const Pulip({Key? key}) : super(key: key);
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(50),
                              side: BorderSide(
                                  width: 1.50, color: Color(0xFF65AA28)),
                            ),
                          ),
                          child: Text(
                            ' 문의하기  ',
                                    ...
                                    children: <Widget>[
                                      CircleAvatar(
                                        ...
                                        backgroundImage: profileImageUrl
                                            ...
                                            : AssetImage(
                                            'assets/images/skon_fly.png') as ImageProvider,
                                      ),
                                      SizedBox(
                                        width: 20.0,
                                      ),
                                    ...
                                    onPressed: () async {
                                      CustomDialog3.showConfirmationDialog(
                                        ...
                                        '비밀번호 재설정 메일을 전송하니\n'
                                          ...
                                          return Future
                                              .value(); // 예시: 비동기적으로 작업을 수행하지 않는 경우에 사용
                                        },
                                      );
                                    },
                                    icon: Icon(
