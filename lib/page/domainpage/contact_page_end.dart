...
class ContactPageEnd extends StatefulWidget {
  const ContactPageEnd({Key? key}) : super(key: key);

  @override
  _ContactPageEndState createState() => _ContactPageEndState();
}

class _ContactPageEndState extends State<ContactPageEnd> {
  ...
  void initState() {
    super.initState();
    _contactStream = FirebaseFirestore.instance.collection('ContactTest').where('state', isEqualTo: true).snapshots();
  }
